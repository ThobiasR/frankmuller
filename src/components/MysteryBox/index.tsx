  ...
  const moreInfoButton = (
    <div className="row -m-2">
      <div className="col col--auto p-2">
        <Link
          href="https://www.binance.com/en/nft/mystery-box/collection/Mystery-by-Franck-Muller?orderBy=list_time&orderType=-1&isBack=1&id=245607891632880640&order=list_time%40-1"
          passHref
        >
          <Button
            as="a"
